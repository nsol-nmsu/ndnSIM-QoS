...
namespace ns3 {
    ...
    int
	    ...
	    int run = 0;	
            ...
            ifstream configFile ( "/home/anju/anju/NDN_QoS/topology/case1.txt", std::ios::in );
            std::string strLine;
	    ...
	    unordered_map<int,int> usedR;
            ...
            tokenHelper.SetAttribute( "FillRate1", StringValue( "500" ) ); // 10 interests a second
            tokenHelper.SetAttribute( "Capacity1", StringValue( "100" ) ); // 10 interests a second
            tokenHelper.SetAttribute( "FillRate2", StringValue( "400" ) ); // 10 interests a second
            tokenHelper.SetAttribute( "Capacity2", StringValue( "100" ) ); // 10 interests a second
            tokenHelper.SetAttribute( "FillRate3", StringValue( "300" ) ); // 10 interests a second
            ...
            char trace[100];
            sprintf( trace, "ndn-case9-run%d.csv", run );
