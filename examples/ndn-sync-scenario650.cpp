...
namespace ns3 {
    ...
    int
	    ...
	    int run = 0;	
            ...
            //ifstream configFile ( "/home/anju/anju/NDN_QoS/test_cases/case.txt", std::ios::in );
            ifstream configFile ( "/home/anju/anju/NDN_QoS/topology/interface/case650.txt", std::ios::in );
            ifstream jsonFile ( "/home/anju/anju/NDN_QoS/topology/interface/data650.txt", std::ios::in );
    ...
    void ReceivedInterestCallbackCom( uint32_t nodeid, shared_ptr<const ndn::Interest> interest ) {
	    ...
	    //std::cout<<Simulator::Now().GetSeconds()<<std::endl;	
            if(interest->getName().getSubName(1,1).toUri() == "/typeI" ){
               ...
               sstr >> iname;
	       std::string str = /*std::to_string(nodeid)*/std::to_string(interest->getPayloadLength()) + " " + interest->getName().getSubName(3,1).toUri().substr(1) + " " + std::to_string(( Simulator::Now().GetNanoSeconds() )/1000000000.0);
