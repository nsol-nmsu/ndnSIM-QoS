...
main( int argc, char* argv[] )
{
  ...
  //ifstream configFile ( "../test_cases/case.txt", std::ios::in );
  ifstream configFile ( "../topology/interface/case650.txt", std::ios::in );
  ifstream jsonFile ( "../topology/interface/data650.txt", std::ios::in );
