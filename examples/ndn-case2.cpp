...
namespace ns3 {
    ...
    int main( int argc, char* argv[] )
    {
        ...
        if ( configFile.is_open () ) {
            while ( std::getline( configFile, strLine ) ) {
                ...
                if( gettingNodeCount == true ) {
                    ...
                    //TODO: Type 1 should be send from LC -> AC and AC -> LC. Where is type I AC -> LC? (100/sec)
                    ...
                    //TODO: Type 2 is send from AC -> LC (120/sec). Why it is 140?
                    ...
                    char temp[10];
                    sprintf( temp, "%lf", 1.0/( float( rand()%40+180 ) ) );     //========= (Type III - 200/sec) (180 - 220)
        ...
        char trace[100];
        sprintf( trace, "ndn-case2-run%d.csv", run );
