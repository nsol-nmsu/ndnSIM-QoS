...
namespace ns3 {
    ...
    int main( int argc, char* argv[] )
    {
        ...
        ifstream configFile ( "/home/anju/anju/NDN_QoS/topology/case2.txt", std::ios::in );
        std::string strLine;
        ...
        if ( configFile.is_open () ) {
            while ( std::getline( configFile, strLine ) ) {
                ...
                if( gettingNodeCount == true ) {
                    ...
                    if ( IsPMUAppInstalled( netParams[1] ) == false ){ 
                        char temp[10];
                        sprintf( temp, "%lf", 1.0/( float( rand()%40+100 ) ) );         //========= AC -> LC (Type II - 100/sec) (100 - 120)
                    ...
                    char temp[10];
                    sprintf( temp, "%lf", 1.0/( float( rand()%40+160 ) ) );     //========= (Type III - 180/sec) (160 - 200)
        ...
        tokenHelper.SetAttribute( "FillRate1", StringValue( "120" ) ); // 10 interests a second
        tokenHelper.SetAttribute( "Capacity1", StringValue( "100" ) ); // 10 interests a second
        tokenHelper.SetAttribute( "FillRate2", StringValue( "100" ) ); // 10 interests a second
        tokenHelper.SetAttribute( "Capacity2", StringValue( "100" ) ); // 10 interests a second
        tokenHelper.SetAttribute( "FillRate3", StringValue( "80" ) ); // 10 interests a second
        tokenHelper.SetAttribute( "Capacity3", StringValue( "100" ) ); // 10 interests a second
        ...
        char trace[100];
        sprintf( trace, "ndn-case6-run%d.csv", run );
